...
Mycket riktigt tog också den nya generationen ett stadigt tag i taktpinnen direkt från start. Elvira, som förvisso inte längre är junior, gjorde rent hus i sin poule varmed hon på vägen tvingade segraren från den första deltävlingen - Janne - på knä. Ian, som fortfarande var yster efter sin fina 3:e plats på JSM, följde Elviras exempel med en pouleseger. I sin framfart kunde Ian bland andra räkna in CH på sin segerlista. Tor kunde med nöd och näppe tvinga till sig en pouleseger och gick därmed in i direktelimineringen med en 12:e ranking. Bäst av alla öppnade Jakim, som med en slug fäktning kunde glädja sig åt en välförtjänt 1:a ranking efter poulerna.
