...
# Get data
results <- read_csv2(here("data", "results2022.csv"))
```
...
```{r load-points-calc, message=FALSE, warning=FALSE, include=FALSE}
source(here("src", "calculate_points.R"))

```

```{r result-table, echo=FALSE, message=FALSE, warning=FALSE}
